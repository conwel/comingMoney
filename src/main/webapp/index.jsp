    ...
    <script>
        ...
        function refreshIframe(){
            ...
            $.post("/getData",{codes:codes},function(result){
                ...
                for(var i=0;i<result.length;i++){
                    ...
                    if(result[i].increase.indexOf("-")){
                        $("#code"+(i+1)).css("color","red");
                        $("#netWorth"+(i+1)).removeClass("label-success");
                        $("#netWorth"+(i+1)).addClass("label-danger");

                        $("#increase"+(i+1)).removeClass("label-success");
                        $("#increase"+(i+1)).addClass("label-danger");

                        $("#interest"+(i+1)).removeClass("label-success");
                        $("#interest"+(i+1)).addClass("label-danger");

                        $("#rich"+(i+1)).removeClass("label-success");
                        $("#rich"+(i+1)).addClass("label-danger");
                    }else{
                        $("#code"+(i+1)).css("color","green");
                        $("#netWorth"+(i+1)).removeClass("label-danger");
                        $("#netWorth"+(i+1)).addClass("label-success");

                        $("#increase"+(i+1)).removeClass("label-danger");
                        $("#increase"+(i+1)).addClass("label-success");

                        $("#interest"+(i+1)).removeClass("label-danger");
                        $("#interest"+(i+1)).addClass("label-success");

                        $("#rich"+(i+1)).removeClass("label-danger");
                        $("#rich"+(i+1)).addClass("label-success");
                    }
        ...
        function start(){
            ...
            if(se != undefined || st != undefined)
                return;
            var titles = ["基金","基金","基金","基金","基金","基金","基金"];
...
<div class="input-group input-group-lg">
    ...
    <input type="text" class="form-control" id="jjdm" placeholder="最多支持7支基金查询">
</div>
<br>
<div class="row">
